...
//     i32* %total_string_lengths, i32* %num_non_null_string_values) #48 {
// entry:
//   %tuple = bitcast %"class.impala::Tuple"* %opaque_tuple to <{ i32, i8 }>*
//   %int8_ptr = bitcast <{ i32, i8 }>* %tuple to i8*
//   %null_bytes_ptr = getelementptr inbounds i8, i8* %int8_ptr, i32 4
...
//       %"class.impala::ScalarExprEvaluator"** %slot_materialize_exprs, i32 0
//   %expr_eval = load %"class.impala::ScalarExprEvaluator"*,
//       %"class.impala::ScalarExprEvaluator"** %0
//   %src = call i64 @GetSlotRef.3(%"class.impala::ScalarExprEvaluator"* %expr_eval,
...
//   select id from functional_orc_def.alltypes_structs order by id limit 2;
